import { ArrowRight, CheckCircle2, Gauge, KeyRound, Layers3, Radar, RefreshCw, ShieldCheck, Sparkles } from 'lucide-react'
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-16 sm:py-24 lg:py-28">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <a href="/how-model-recommendations-stay-current" className="inline-flex h-12 items-center justify-center rounded-xl border border-border/70 bg-card/55 px-6 font-semibold transition-colors hover:border-blue-500/35">
      ...
      <section className="border-y border-border/50 bg-muted/10">
        <div className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
          <div className="grid gap-5 lg:grid-cols-2">
            <article className="rounded-2xl border border-violet-500/20 bg-violet-500/[0.045] p-6 sm:p-7">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-violet-500">Independent performance evidence</p>
              <h2 className="mt-3 text-2xl font-extrabold tracking-tight">Artificial Analysis</h2>
              ...
              <a href="/artificial-analysis" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-violet-500">
                How Artificial Analysis contributes <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </a>
            </article>

            <article className="rounded-2xl border border-cyan-500/20 bg-cyan-500/[0.045] p-6 sm:p-7">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-cyan-500">Current operational facts</p>
              <h2 className="mt-3 text-2xl font-extrabold tracking-tight">OpenRouter</h2>
              <p className="mt-3 text-sm leading-6 text-muted-foreground">
              ...
              <a href="/openrouter-model-comparison" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-cyan-500">
                Compare OpenRouter models by workload <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </a>
            </article>
          </div>

          <div className="mt-5 flex gap-3 rounded-2xl border border-border/60 bg-background/65 p-5">
            <RefreshCw className="mt-0.5 h-5 w-5 shrink-0 text-blue-400" aria-hidden="true" />
